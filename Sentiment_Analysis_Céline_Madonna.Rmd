...
!Love is by far the most common word, the second place belongs to "heart" followed by "feel" .
...
Here we can see that the variety of words conttributing to positive sentiments is quite big.
...
For Madonna, we can see that there are only 3 words that appear more than 5 times that contribute to positive or negative sentiments.It seems that Madonna's words are potentially more neutral, at least those, that are present at least 5 times in her songs.
...
My hypothesis, that Céline Dion's song are more positive than Madonna's seem to be proved right.This is on eof the rare cases when the hypothesis cannot be rejected.
...
I also looked at wordclouds to get an overall picture of what words seem most important for the two artists.
